          ...
          <div className="w-full md:w-1/2 space-y-8 flex flex-col justify-between">
            <div>
              ...
              <div className="space-y-4 text-gray-700 text-base">
                ...
                <p className="flex flex-col gap-1 pt-2"><span className="font-semibold text-[#295A47] text-lg">Operating Hours:</span><span>🕒 Monday - Saturday: 10:00 AM to 7:00 PM</span><span>❌ Sunday: Closed</span></p>
              </div>
            </div>
